namespace NocturnalGroup.ValuableEnums.Tests.Debug;
...
[EnumField<TestEnum[]>("typeEnumArray", [TestEnum.Default, TestEnum.Default])]
[EnumField<TestEnum[]>("typeEnumArray2", new TestEnum[] {TestEnum.Default, TestEnum.Default})]
public enum NamespacedEnum
{
	...
	[EnumField<TestEnum[]>("typeEnumArray", [TestEnum.Override, TestEnum.Override])]
	AllOverrides = 2,
}
